...
import { createRecipeAPI } from "@/lib/api/recipes";
...
export default function CreateRecipePage() {
  ...
  const removeIngredient = (index: number) => {
    ...
    setFormData((prev) => ({
      ...prev,
      extendedIngredients: prev.extendedIngredients.filter(
        (_, i) => i !== index
      ),
    }));
  };
      ...
      analyzedInstructions: [
        {
          ...
          steps: prev.analyzedInstructions[0].steps.map((step, i) =>
            i === stepIndex
              ? {
                  ...step,
                  equipment: step.equipment.filter(
                    (_, j) => j !== equipmentIndex
                  ),
                }
              : step
          ),
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      formData.analyzedInstructions[0].steps.some((step) => !step.step.trim())
    ) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="title">
                    Recipe Title <span className="text-red-800">*</span>
                  </Label>
                  <Input
                    id="title"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("readyInMinutes", e.target.value)
                      }
                    />
                  </div>
              ...
              <div className="space-y-3">
                <Label className="text-lg font-semibold">
                  Ingredients <span className="text-red-800">*</span>
                </Label>
              ...
              <div className="space-y-4">
                <Label className="text-lg font-semibold">
                  Instructions <span className="text-red-800">*</span>
                </Label>
                {formData.analyzedInstructions[0].steps.map(
                  (stepObj, index) => (
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2 items-start">
                          ...
                          <Button
                            ...
                            disabled={
                              formData.analyzedInstructions[0].steps.length ===
                              1
                            }
                          >
                            <X className="w-4 h-4" />
                              ...
                              {stepObj.ingredients.map((ing, ingIndex) => (
                                ...
                                >
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      removeStepIngredient(index, ingIndex)
                                    }
                              ...
                              {stepObj.equipment.map((equip, equipIndex) => (
                                ...
                                >
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      removeStepEquipment(index, equipIndex)
                                    }
