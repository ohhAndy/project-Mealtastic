...
import { checkId, checkLimit, checkPage, checkPlanId, checkQuantity, checkQueryPlanId } from "../middlewares/validate";
...
router.patch("/item/:id", isAuthenticated, checkId, checkQuantity, shoppingListCtrl.updateShoppingItem);
